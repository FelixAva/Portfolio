const Summary = () => {
  return (
    <section id='summary' className='snap-start md:min-h-[calc(100vh-96px)] bg-[#EFE9E3] flex justify-center items-center gap-8'>
      <img src="/assets/me.webp" alt="Image of myself" className='w-80 h-full rounded-full' />
